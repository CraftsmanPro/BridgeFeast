...
const GenerateRecipeOutputSchema = z.object({
  ...
  instructions: z.string().describe('The preparation steps for the recipe.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a recipe generation expert. Given a list of ingredients, generate a delicious and easy-to-follow recipe.

Ingredients: {{{ingredients}}}

Recipe Title:
Ingredients List (one ingredient per line):
Instructions:`,
});
